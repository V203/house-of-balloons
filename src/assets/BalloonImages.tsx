...
let BalloonImages = (props: any) => {
    ...
    return (
            ...
            <svg width="50" height="70" viewBox="0 0 88 134" fill={basecolor} xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    <filter id="filter0_d_3_31" x="0" y="0" width="88" height="149" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    <filter id="filter1_i_3_31" x="21" y="0" width="71" height="64.5" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                        <feFlood floodOpacity="0" result="BackgroundImageFix" />
